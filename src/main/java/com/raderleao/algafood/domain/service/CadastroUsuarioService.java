...
import com.raderleao.algafood.domain.exception.UsuarioNaoEncontradoException;
...
public class CadastroUsuarioService {
	...
	private static final String MSG_USUARIO_EM_USO = "Usuario de código %d não pode ser removido, pois esta em uso";
	...
	public Usuario salvar(Usuario usuario) {
		...
		if( usuarioExistente.isPresent() && Usuario.IsDifferent(usuario, usuarioExistente.get()) ) {
